...
export async function departVehicle(eventId: string, vehicleId: string, userId: string, reviewedToken: string) {
  ...
  await runTransaction(db, async (transaction) => {
    ...
    transaction.update(tripRef, {
      ...
      departureSnapshot: buildDepartureSnapshot(committedReview), arrivedAtEventByUserId: null, returnStartedByUserId: null, originalReturnSnapshot: null, returnDriverMirrorsDeparture: false, updatedAt: serverTimestamp(),
    })
