...
- REQ-134: Active approved Admin and Staff may correct effective return rosters after Start Return, Returned, or event completion. Each atomic operation updates current `returnVehicleId`, optionally clears a disclosed return-driver role, and appends immutable user/time correction history without reopening lifecycle or changing original snapshots.
